  ...
  return (
    ...
    <Box mt={6} p={3} sx={{ backgroundColor: '#f7f7fa', borderRadius: 2, boxShadow: 1 }}>
      ...
      <Typography gutterBottom>
        ...
        <b>Note:</b> The Windows installer is delivered as an <b>EXE file</b> For macOS, the installer is delivered as a <b>DMG file</b>. If you have any issues, contact your instructor via Slack.
      </Typography>
      <Box display="flex" gap={2} mt={2}>
        <Button
          variant="contained"
          color="primary"
          href="https://drive.google.com/file/d/1HSojIpyMzWnL_EC3RJisO-AEaUKKNgZG/view?usp=drive_link"
          target="_blank"
